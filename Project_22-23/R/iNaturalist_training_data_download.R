...
get_recs <- function(name,taxon_id){
  ...
  return(recs)}
download_images <- function(spp_recs =NULL, image_folder =("~/BIO3199/Vincent's_Project/Python/training_data/raw_images"),spp_folder=NULL){
...
bird_list <- read.csv("bird_list.csv")
